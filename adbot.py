...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "6a78855c30ceb0c593a231fd")
    api_token = os.getenv("API_TOKEN", "461c9a19f02dcf48d768f5ee90b47e23ecaeeedda23577dbc89514d5fe1a4725")
