...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "6a7b400049207abec9796fa5")
    api_token = os.getenv("API_TOKEN", "a98955d177094fd018a324318ffcde1879a9453453656aabbd8bc3837fd26e5e")
