...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "https://create.highrise.game/asset-catalog/6a78855c30ceb0c593a231fd")
    api_token = os.getenv("API_TOKEN", "7725315a6f1c7e9c8923693bc0d23ad89ab65b3370866402cb34df681150845d")
